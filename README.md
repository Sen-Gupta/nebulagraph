...
A Dapr pluggable component that provides ## 📁 File Structure
...
This structure allows for easy extension with additional store types while keeping the codebase organized and maintainable.nctionality using NebulaGraph as the backend.
